...
subtitle: "Progress meeting 20.04.2024"
author: "Leo Helling"
...
-   HMM:
    ...
    -   multivariate HMM, e.g. with [dempixS4-package](https://cran.r-project.org/web/packages/depmixS4/vignettes/depmixS4.pdf)

-   further classification methods:

    -   DBSCAN: density-based clustering (based on 1 - minimum number of group members and 2 - ε-neighborhood, the size and borders of each neighborhood), see https://towardsdatascience.com/a-practical-guide-to-dbscan-method-d4ec5ab2bc99
